...
public class PageDomainCount extends Configured implements Tool {

	private static final Logger LOG = Logger.getLogger(PageDomainCount.class);
	...
	public int run(String[] args) throws Exception {
		...
		job.setJarByClass(PageDomainCount.class);
		...
		job.setMapperClass(PageDomainCount.PageDomaincountMapper.class);
	...
	public static void main(String[] args) throws Exception {
		int res = ToolRunner.run(new Configuration(), new PageDomainCount(),
				args);
		System.exit(res);
	}
}
