...
/*
 * 
 * this class can be used with PigLatin to load the ARC files
 * LOAD 'arc file name' USING ArcLoader
 */
...
public class ArcLoader extends LoadFunc {
	...
	public Tuple getNext() throws IOException {
		try {
			...
			/**
			 * This is where you can put other data in.  anything you
			 * can find in org.commoncrawl.hadoop.mapred.ArcRecord you can put
			 * into the Tuple.
			 */
